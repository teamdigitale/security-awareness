...
pm:
  pm-1:
    ...
    descr: Andrea è un appassionato di tecnologia con 16 anni di esperienza pratica in sicurezza informatica, sistemi operativi e architetture di sicurezza cloud.
  pm-2:
    name: Alice Casiraghi
    title: UX designer e illustratrice
    org: Team per la Trasformazione Digitale
    img: alice_casiraghi.png
    descr: Alice è un service e graphic designer digitale, il cui lavoro spazia dalla consulenza e dalla ricerca di design al design del marchio, dell'illustrazione, della UX e dell'interfaccia utente. 
  pm-3:
    name: Andrea Biancini
    title: Responsabile open source
    org: Team per la Trasformazione Digitale
    img: andrea_biancini.png
    descr: Andrea è un direttore esperto nello sviluppo della cultura aziendale, nella definizione della strategia e nella progettazione organizzativa, con 15 anni di esperienza presso importanti aziende/istituti di ricerca internazionali.
  pm-4:
